...
@section('backend-content')
                            ...
                            <div class="active section">Add new Student Class</div>
                        </div> <!-- End Breadcrumb -->
                    ...
                    <div class="column">
                        <div class="ui basic compact segment">
                            <div class="ui top attached menu">
                                <div class="item">
                                    <h4 class="ui orange header">Add new Student Class</h4>
                                </div>
                            </div>
                            <div class="ui bottom attached segment">
                                <form class="ui form" method="POST" action="{{ route('backend.studentclass.create.post') }}">
                                    {{ csrf_field() }}
                                    <div class="field">
                                    	<div class="ui left icon input">
                                    		<i class="student icon"></i>
                                    		<input type="text" name="name" value="{{ old('name') }}" placeholder="Student Class">
                                    	</div>
                                    </div>
