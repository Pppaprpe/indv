...
@section('frontend-content')
                ...
                <div class="caption-form">
                    <h2 class="animated fadeInLeftBig">Re-Booking your Simulator</h2>
                    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                        <form class="form animated fadeInRightBig" method="POST" action="{{ route('frontend.simulator.rebooking.post') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group {{ $errors->has('startdate') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control text-center" type="text" name="startdate" id="startdate" placeholder="Choose your Start Date" value="{{ $booking->startdate }}">
