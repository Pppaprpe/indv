...
class SimulatorBookingController extends Controller
{
    /**
    ...
    public function index(Booking $booking)
    {
    	...
    	return view('frontend.simulator.mybooking', $data);
    }
    ...
    public function getBooking()
    {
        ...
        return view('frontend.simulator.booking', $data);
    }
    ...
    public function postBooking(Request $request, LogRepository $log, TurnRepository $turn)
    {
        ...
        return redirect()->route('frontend.simulator.mybooking');
    }
    ...
    public function getReBooking($bookingID)
    {
        ...
        return view('frontend.simulator.rebooking', $data);
    }
