...
@section('frontend-content')
                ...
                <div class="caption-form">
                    <h2 class="animated fadeInLeftBig">Booking Flight</h2>
                    <div class="row">
                    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                        <form class="form animated fadeInRightBig" method="POST" action="{{ route('frontend.flight.booking.post') }}">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="form-group {{ $errors->has('syllabus') ? 'has-error' : '' }}">
                                        ...
                                        <select class="form-control" id="syllabus" name="syllabus">
                                            ...
                                            @foreach ($course as $a)
                                                <option value="{{ $a->id }}" {{ ( old('syllabus') == $a->id ? 'selected' : '' ) }}>{{ $a->name }}</option>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group {{ $errors->has('startdate') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control text-center" type="text" name="startdate" id="startdate" placeholder="Choose your Date" value="{{ old('startdate') }}">
